...
module.exports = {
  ...
  coverageReporters: ['json', 'lcov', 'text', 'cobertura'], // [array<string>]
  ...
  moduleNameMapper: {
    ...
    '\\.svg': '<rootDir>/src/test/utils/svgrMock.js',
    '^.+\\.md?$': 'markdown-loader-jest',
  },

  errorOnDeprecated: true, // [boolean]
  ...
  // clearMocks: // [boolean]
  reporters: ['default', 'jest-junit', 'jest-puppeteer-istanbul/lib/reporter'], // [array<moduleName | [moduleName, options]>]
  // resetMocks: // [boolean]
  ...
  // roots: // [array<string>]
  // setupFiles: // [array]
  setupFilesAfterEnv: ['jest-extended', 'jest-puppeteer-istanbul/lib/setup'],
